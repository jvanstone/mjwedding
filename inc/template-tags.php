...
if ( ! function_exists( 'mjwedding_posted_on' ) ) {
	/**
...
if ( ! function_exists( 'mjwedding_posted_by' ) ) {
	/**
...
if ( ! function_exists( 'mjwedding_entry_meta_footer' ) ) {
	/**
	 ...
	 * @return void
	 */
	function mjwedding_entry_meta_footer() {
		...
		if ( ! is_single() ) {
			...
			if ( 'aside' === $post_format || 'status' === $post_format ) {
				echo '<p><a href="' . esc_url( get_permalink() ) . '">' . mjwedding_continue_reading_text() . '</a></p>'; // phpcs:ignore WordPress.Security.EscapeOutput
			}
...
if ( ! function_exists( 'mjwedding_post_thumbnail' ) ) {
	/**
	 ...
	 * @return void
	 */
	function mjwedding_post_thumbnail() {
		if ( ! mjwedding_can_show_post_thumbnail() ) {
			return;
		}
		?>
...
if ( ! function_exists( 'mjwedding_the_posts_navigation' ) ) {
	/**
	 ...
	 * @return void
	 */
	function mjwedding_the_posts_navigation() {
