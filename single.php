...
while ( have_posts() ) :
	...
	$mjwedding_next = is_rtl() ? mjwedding_get_icon_svg( 'ui', 'arrow_left' ) : mjwedding_get_icon_svg( 'ui', 'arrow_right' );
	$mjwedding_prev = is_rtl() ? mjwedding_get_icon_svg( 'ui', 'arrow_right' ) : mjwedding_get_icon_svg( 'ui', 'arrow_left' );
