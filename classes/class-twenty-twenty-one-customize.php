		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'mjwedding' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'mjwedding' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'mjwedding' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'mjwedding' ),
						'full'    => esc_html__( 'Full text', 'mjwedding' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-mj_wedding-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			...
			$wp_customize->add_control(
				new mj_wedding_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'mjwedding' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
